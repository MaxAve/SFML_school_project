...
- **Deniel:**
    - [ ] Looting:
        - [X] Make it possible to stack the same object type (also: create some variable to control how much of each item can be stacked in a single slot)
        - [ ] Make a hotbar with 5 item slots
            - [X] hotbar appears in the ui
            - [ ] Make hotbar appear in the invetories
    - [ ] Tilemap:
