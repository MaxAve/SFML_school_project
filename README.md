...
- **Deniel:**
    - [ ] Loot system:
        ...
        - [X] When the player is close to the ```LootContainer```, a sprite with the ```q_key_prompt.png``` texture should appear and hover over the box so that the player knows to press Q to open it.
    - [ ] Tilemap:
