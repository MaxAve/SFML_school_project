...
- **Daniel:**
    - Make the window resizable and add fullscreen mode (please make a seperate branch for this)
...
- **Maks:**
    - Create a class ```Building``` where a player can enter and exit. Entering the building will teleport the player to a different map with the building's layout. If any zombies were chasing the player before they entered the building, they should have a chance to enter the building aswell.
