...
Player::Player(sf::RenderWindow& window) : inventory({(float)window.getSize().x * 0.75f, (float)window.getSize().y * 0.75f}, {(float)window.getSize().x / 2, (float)window.getSize().y / 2}) {
